...
class SettingWindow(QMainWindow):
    ...
    def initUI(self,Main_ins):
        ...
        b1.enterEvent=lambda event:SettingWindow.showtext('数字越大性能开销越大!')
        b2=QPushButton()
        ...
        b19.enterEvent=lambda event:SettingWindow.showtext('背景色的优先级大于主题样式,更改后注意保存')
        b3=QPushButton()
        ...
        b9.enterEvent=lambda event:SettingWindow.showtext('数字越大运动越慢,建议500-1000')
        b10=QPushButton()
        ...
        b11.enterEvent=lambda event:SettingWindow.showtext(curve_des[combobox1.currentIndex()])
        b12=QPushButton()
